...
export default function DebugPatternsPage() {
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto pb-32 md:pb-0 p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card border border-border rounded-lg p-4">
            ...
            {debugInfo.length === 0 ? (
              <p className="text-sm text-muted-foreground">No impact pairs to analyze. Need at least 2 logged impacts.</p>
            ) : (
              <div className="space-y-4">
                {debugInfo.map((info, idx) => (
                  <div key={idx} className={`border rounded-lg p-3 ${info.tooLargeGap ? 'border-red-500 bg-red-50 dark:bg-red-950' : 'border-border'}`}>
